...
_POLISH_SYSTEM = """Sen Kemal Kaya'nın sesini koruyan kıdemli bir editörsün.
...
KEMAL KAYA SESİ:
• 1971 doğumlu, 1995'ten beri aktif gezgin, yoldaolmak.com
...
def ask_claude_polish(gpt_html: str, section_label: str = "") -> str:
    ...
    prompt  = f"""{label}Gutenberg HTML içeriğini Kemal'in sesine göre düzelt.
