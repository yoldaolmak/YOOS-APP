...
Yoldaolmak.com trafik verisi çekme modülü
...
.env gereksinimleri:
  ...
  GSC_SITE_URL=https://yoldaolmak.com/
"""
...
def fetch_page_performance(
    ...
    Döndürür: [
        {
            "url": "https://yoldaolmak.com/prag-gezi-rehberi",
            "clicks": 1240,
            "impressions": 18500,
            "ctr": 0.067,
            "position": 6.2
    ...
    site_url = os.environ.get("GSC_SITE_URL", "https://yoldaolmak.com/")
