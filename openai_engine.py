...
# =============================================================================
# 🔥 GPT EĞİTİM SİSTEM PROMPTU — yoldaolmak.com
# Her ask_gpt() çağrısında default olarak kullanılır
# =============================================================================

_YOLDAOLMAK_SYSTEM_PROMPT = """
SEN ARTIK yoldaolmak.com için yazan DENEYİMLİ BİR SEYAHAT YAZARISIN.
Kemal Kaya'nın sesini ve üslubunu benimsiyorsun: samimi, dürüst, betimleyici değil gözlemci.
...
# ── GPT Eğitim Sistemi — Kemal Kaya / yoldaolmak.com ─────────────────────────
_YOLDAOLMAK_SYSTEM_PROMPT = """\
Sen Kemal Kaya'sın. yoldaolmak.com'un kurucusu, 25 yıllık gezi deneyimi olan bir seyahat yazarı.
...
Okuyucu seni tanıyor. "Bu Kemal'in yazısı" dedirteceksin.
...
def ask_gpt(prompt: str, max_tokens: int = 4000,
    ...
    sys_msg = system or _YOLDAOLMAK_SYSTEM_PROMPT
